...
function VietinbankInterestView() {
	...
	return (
		<>
			<HeaderSeo
				title="Lãi suất Vietinbanj"
				description="Vietinbanj - tra cứu lãi suất tiền gửi và vay mới nhất. Xem thông tin chi tiết về các sản phẩm tài chính, so sánh lãi suất và lựa chọn giải pháp tài chính hiệu quả với Vietinbanj - ngân hàng uy tín, đáng tin cậy."
				url="/lai-suat-ngan-hang/vietinbank"
			/>
			<MainLayout>
							...
							<div>
								...
								<div className=" mt-[4rem] text-black-text">
									<h1 className="text-[2.4rem] text-blue-text font-medium">
										Giới thiệu về VietinBank – Ngân hàng
									...
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										...
										tên viết tắt: "VietinBank", là một ngân
										hàng thương mại lớn của Việt Nam.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Được thành lập từ năm 1988 sau khi tách
										ra từ Ngân hàng Nhà nước Việt Nam.[2]
										Tên giao dịch ban đầu là IncomBank. Năm
										2008, IncomBank đổi tên thành
										Vietinbank. VietinBank hiện có 1 Sở giao
										dịch, 150 Chi nhánh và trên 1000 Phòng
										giao dịch/ Quỹ tiết kiệm trải rộng trên
										toàn quốc.
									</p>
								</div>
							</div>
