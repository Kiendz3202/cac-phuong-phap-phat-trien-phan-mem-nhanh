...
function ScbInterestView() {
	...
	return (
		<>
			<HeaderSeo
				title="Lãi suất SCB"
				description="SCB - tra cứu lãi suất tiền gửi và vay mới nhất. Xem thông tin chi tiết về các sản phẩm tài chính, so sánh lãi suất và lựa chọn giải pháp tài chính hiệu quả với SCB - ngân hàng uy tín, đáng tin cậy."
				url="/lai-suat-ngan-hang/scb"
			/>
			<MainLayout>
							...
							<div>
								...
								<div className=" mt-[4rem] text-black-text">
									<h1 className="text-[2.4rem] text-blue-text font-medium">
										Giới thiệu về SCB – Ngân hàng Thương Mại
										Cổ Phần Sài Gòn
									</h1>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Ngân hàng Thương mại cổ phần Sài Gòn
										(tên giao dịch bằng tiếng Anh Sai Gon
										Joint Stock Commercial Bank, viết tắt là
										SCB) là một ngân hàng thương mại tại
										Việt Nam có trụ sở đặt tại Thành phố Hồ
										Chí Minh.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										SCB được hợp nhất vào năm 2012 từ ba
										ngân hàng Đệ Nhất (Ficombank), Việt Nam
										Tín Nghĩa (TinNghiaBank) và Sài Gòn
										(SCB) đều có trụ sở tại Thành phố Hồ Chí
										Minh. Đây là thương vụ hợp nhất đầu tiên
										trong ngành ngân hàng Việt Nam, đánh dấu
										sự bắt đầu quá trình tái cấu trúc hệ
										thống ngân hàng.
									</p>
								</div>
							</div>
