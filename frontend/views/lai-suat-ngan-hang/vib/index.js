...
function VibInterestView() {
	...
	return (
		<>
			<HeaderSeo
				title="Lãi suất VIB"
				description="VIB - tra cứu lãi suất tiền gửi và vay mới nhất. Xem thông tin chi tiết về các sản phẩm tài chính, so sánh lãi suất và lựa chọn giải pháp tài chính hiệu quả với VIB - ngân hàng uy tín, đáng tin cậy."
				url="/lai-suat-ngan-hang/vib"
			/>
			<MainLayout>
							...
							<div>
								...
								<div className=" mt-[4rem] text-black-text">
									<h1 className="text-[2.4rem] text-blue-text font-medium">
										Giới thiệu về VIB – Ngân hàng Thương mại
										cổ phần Quốc Tế Việt Nam
									</h1>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Ngân hàng Thương mại cổ phần (TMCP) Quốc
										Tế Việt Nam, tên viết tắt Ngân hàng Quốc
										Tế (VIB), là một trong những ngân hàng
										TMCP hàng đầu tại Việt Nam.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Sau hơn 20 năm thành lập, VIB đã đạt
										được những bước phát triển vượt bậc
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Thành lập ngày 18/9/1996, VIB bắt đầu đi
										vào hoạt động với số vốn điều lệ ban đầu
										là 50 tỷ đồng và 23 cán bộ nhân viên.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Đến ngày 30/06/2022,vốn điều lệ VIB đạt
										hơn 21.076 tỷ đồng. Vốn chủ sở hữu đạt
										hơn 28.250 tỷ đồng và tổng tài sản đạt
										hơn 348.000 tỷ đồng.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										VIB hiện có hơn 11.000 cán bộ nhân viên,
										làm việc tại 174 chi nhánh và phòng giao
										dịch ở 27 tỉnh/thành trọng điểm trong cả
										nước.
									</p>
								</div>
							</div>
