...
function VietcombankInterestView() {
	...
	return (
		<>
			<HeaderSeo
				title="Lãi suất Vietcombank"
				description="Vietcombank - tra cứu lãi suất tiền gửi và vay mới nhất. Xem thông tin chi tiết về các sản phẩm tài chính, so sánh lãi suất và lựa chọn giải pháp tài chính hiệu quả với Vietcombank - ngân hàng uy tín, đáng tin cậy."
				url="/lai-suat-ngan-hang/vietcombank"
			/>
			<MainLayout>
							...
							<div>
								...
								<div className=" mt-[4rem] text-black-text">
									<h1 className="text-[2.4rem] text-blue-text font-medium">
										Giới thiệu về Vietcombank – Ngân hàng
									...
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										...
										Vietnam) tên viết tắt: "Vietcombank", là
										công ty lớn nhất trên thị trường chứng
										khoán Việt Nam tính theo vốn hóa.
									</p>
									<p className="text-[1.8rem] mt-[1rem] font-normal">
										Tại ngày 30/06/2020, Vietcombank có
										30.115 nhân viên, Ngân hàng có 1 Trụ sở
										chính, 1 Trường Đào tạo và Phát triển
										nguồn nhân lực Vietcombank, 2 Trung tâm
										xử lý tiền mặt, 116 chi nhánh trên toàn
										quốc, 4 công ty con tại Việt Nam, 3 Công
										ty con tại nước ngoài, 2 công ty liên
										doanh, 1 công ty liên kết, 1 văn phòng
										đại diện đặt tại Mỹ, 1 văn phòng đại
										diện đặt tại Singapore và 1 văn phòng
