...
function CoinPageView() {
	...
	return (
		<>
			<HeaderSeo
				title="Tiền điện tử-Giá tiền điện tử cập nhật mới nhất"
				description="Trao đổi tiền điện tử một cách thuận tiện và an toàn với nền tảng tiên tiến của chúng tôi. Mua, bán và giao dịch Bitcoin, Ethereum, Litecoin và các tài sản kỹ thuật số phổ biến khác với mức giá cạnh tranh. Giao diện thân thiện với người dùng, các biện pháp bảo mật mạnh mẽ và hỗ trợ khách hàng 24/7 đảm bảo trải nghiệm không trở ngại cho cả người mới bắt đầu và chuyên gia."
				url="/coin"
			/>
			<MainLayout>
				{/* mx-[2.1rem] */}
